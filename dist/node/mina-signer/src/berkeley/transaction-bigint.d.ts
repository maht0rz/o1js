import { PublicKey, UInt64, UInt32, TokenId, Field, AuthRequired, BalanceChange, Sign, Bool } from '../../../bindings/mina-transaction/v1/transaction-leaves-bigint.js';
import { GenericSignable } from '../../../bindings/lib/generic.js';
import { GenericLayout } from '../../../bindings/lib/from-layout.js';
import * as Json from '../../../bindings/mina-transaction/gen/v1/transaction-json.js';
declare const TransactionVersion: {
    empty: () => bigint;
    toInput(x: bigint): import("../derivers-bigint.js").HashInput;
    maxValue: bigint;
    random(): bigint;
