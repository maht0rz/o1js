...
export const wasmfqgatevector_deserialize: (a: number, b: number) => [number, number, number];
export const wasmfqgatevector_serialize: (a: number) => [number, number, number, number];
...
export const wasmpastafpplonkindex_deserialize: (a: number, b: number) => [number, number, number];
export const wasmpastafpplonkindex_serialize: (a: number) => [number, number, number, number];
export const wasmpastafpruntimetablecfg_new: (a: number, b: number, c: number) => number;
export const wasmpastafqplonkindex_deserialize: (a: number, b: number) => [number, number, number];
export const wasmpastafqplonkindex_serialize: (a: number) => [number, number, number, number];
...
export const wasmfqsrs_deserialize: (a: number, b: number) => [number, number, number];
export const wasmfqsrs_serialize: (a: number) => [number, number, number, number];
...
export const wasmfpgatevector_deserialize: (a: number, b: number) => [number, number, number];
export const wasmfpgatevector_serialize: (a: number) => [number, number, number, number];
...
export const wasmfpsrs_deserialize: (a: number, b: number) => [number, number, number];
export const wasmfpsrs_serialize: (a: number) => [number, number, number, number];
