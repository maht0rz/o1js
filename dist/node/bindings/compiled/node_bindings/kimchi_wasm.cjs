 ...
 * @enum {0 | 1}
 */
const CurrOrNext = Object.freeze({
    Curr: 0, "0": "Curr",
    Next: 1, "1": "Next",
});
exports.CurrOrNext = CurrOrNext;
...
if (Symbol.dispose) FeatureFlags.prototype[Symbol.dispose] = FeatureFlags.prototype.free;
...
if (Symbol.dispose) LookupFeatures.prototype[Symbol.dispose] = LookupFeatures.prototype.free;
exports.LookupFeatures = LookupFeatures;
...
if (Symbol.dispose) LookupInfo.prototype[Symbol.dispose] = LookupInfo.prototype.free;
...
if (Symbol.dispose) LookupPatterns.prototype[Symbol.dispose] = LookupPatterns.prototype.free;
...
if (Symbol.dispose) PoolBuilder.prototype[Symbol.dispose] = PoolBuilder.prototype.free;
...
if (Symbol.dispose) WasmFpDomain.prototype[Symbol.dispose] = WasmFpDomain.prototype.free;
exports.WasmFpDomain = WasmFpDomain;
...
if (Symbol.dispose) WasmFpGate.prototype[Symbol.dispose] = WasmFpGate.prototype.free;
exports.WasmFpGate = WasmFpGate;
...
class WasmFpGateVector {
    ...
    static deserialize(bytes) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmfpgatevector_deserialize(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WasmFpGateVector.__wrap(ret[0]);
    }
    /**
     * @returns {Uint8Array}
     */
    serialize() {
        const ret = wasm.wasmfpgatevector_serialize(this.__wbg_ptr);
        if (ret[3]) {
...
if (Symbol.dispose) WasmFpGateVector.prototype[Symbol.dispose] = WasmFpGateVector.prototype.free;
exports.WasmFpGateVector = WasmFpGateVector;
...
if (Symbol.dispose) WasmFpLookupCommitments.prototype[Symbol.dispose] = WasmFpLookupCommitments.prototype.free;
exports.WasmFpLookupCommitments = WasmFpLookupCommitments;
...
if (Symbol.dispose) WasmFpLookupSelectors.prototype[Symbol.dispose] = WasmFpLookupSelectors.prototype.free;
exports.WasmFpLookupSelectors = WasmFpLookupSelectors;
...
if (Symbol.dispose) WasmFpLookupVerifierIndex.prototype[Symbol.dispose] = WasmFpLookupVerifierIndex.prototype.free;
exports.WasmFpLookupVerifierIndex = WasmFpLookupVerifierIndex;
...
if (Symbol.dispose) WasmFpOpeningProof.prototype[Symbol.dispose] = WasmFpOpeningProof.prototype.free;
exports.WasmFpOpeningProof = WasmFpOpeningProof;
...
if (Symbol.dispose) WasmFpOracles.prototype[Symbol.dispose] = WasmFpOracles.prototype.free;
exports.WasmFpOracles = WasmFpOracles;
...
if (Symbol.dispose) WasmFpPlonkVerificationEvals.prototype[Symbol.dispose] = WasmFpPlonkVerificationEvals.prototype.free;
exports.WasmFpPlonkVerificationEvals = WasmFpPlonkVerificationEvals;
...
if (Symbol.dispose) WasmFpPlonkVerifierIndex.prototype[Symbol.dispose] = WasmFpPlonkVerifierIndex.prototype.free;
exports.WasmFpPlonkVerifierIndex = WasmFpPlonkVerifierIndex;
...
if (Symbol.dispose) WasmFpPolyComm.prototype[Symbol.dispose] = WasmFpPolyComm.prototype.free;
exports.WasmFpPolyComm = WasmFpPolyComm;
...
if (Symbol.dispose) WasmFpProverCommitments.prototype[Symbol.dispose] = WasmFpProverCommitments.prototype.free;
exports.WasmFpProverCommitments = WasmFpProverCommitments;
...
if (Symbol.dispose) WasmFpProverProof.prototype[Symbol.dispose] = WasmFpProverProof.prototype.free;
exports.WasmFpProverProof = WasmFpProverProof;
...
if (Symbol.dispose) WasmFpRandomOracles.prototype[Symbol.dispose] = WasmFpRandomOracles.prototype.free;
exports.WasmFpRandomOracles = WasmFpRandomOracles;
...
if (Symbol.dispose) WasmFpRuntimeTable.prototype[Symbol.dispose] = WasmFpRuntimeTable.prototype.free;
exports.WasmFpRuntimeTable = WasmFpRuntimeTable;
...
if (Symbol.dispose) WasmFpShifts.prototype[Symbol.dispose] = WasmFpShifts.prototype.free;
exports.WasmFpShifts = WasmFpShifts;
...
class WasmFpSrs {
    ...
    static deserialize(bytes) {
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmfpsrs_deserialize(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WasmFpSrs.__wrap(ret[0]);
    }
    /**
     * @returns {Uint8Array}
     */
    serialize() {
        const ret = wasm.wasmfpsrs_serialize(this.__wbg_ptr);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
if (Symbol.dispose) WasmFpSrs.prototype[Symbol.dispose] = WasmFpSrs.prototype.free;
exports.WasmFpSrs = WasmFpSrs;
...
if (Symbol.dispose) WasmFqDomain.prototype[Symbol.dispose] = WasmFqDomain.prototype.free;
exports.WasmFqDomain = WasmFqDomain;
...
if (Symbol.dispose) WasmFqGate.prototype[Symbol.dispose] = WasmFqGate.prototype.free;
exports.WasmFqGate = WasmFqGate;
...
class WasmFqGateVector {
    ...
    static deserialize(bytes) {
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmfqgatevector_deserialize(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WasmFqGateVector.__wrap(ret[0]);
    }
    /**
     * @returns {Uint8Array}
     */
    serialize() {
        const ret = wasm.wasmfqgatevector_serialize(this.__wbg_ptr);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
if (Symbol.dispose) WasmFqGateVector.prototype[Symbol.dispose] = WasmFqGateVector.prototype.free;
exports.WasmFqGateVector = WasmFqGateVector;
...
if (Symbol.dispose) WasmFqLookupCommitments.prototype[Symbol.dispose] = WasmFqLookupCommitments.prototype.free;
exports.WasmFqLookupCommitments = WasmFqLookupCommitments;
...
if (Symbol.dispose) WasmFqLookupSelectors.prototype[Symbol.dispose] = WasmFqLookupSelectors.prototype.free;
exports.WasmFqLookupSelectors = WasmFqLookupSelectors;
...
if (Symbol.dispose) WasmFqLookupVerifierIndex.prototype[Symbol.dispose] = WasmFqLookupVerifierIndex.prototype.free;
exports.WasmFqLookupVerifierIndex = WasmFqLookupVerifierIndex;
...
if (Symbol.dispose) WasmFqOpeningProof.prototype[Symbol.dispose] = WasmFqOpeningProof.prototype.free;
exports.WasmFqOpeningProof = WasmFqOpeningProof;
...
if (Symbol.dispose) WasmFqOracles.prototype[Symbol.dispose] = WasmFqOracles.prototype.free;
exports.WasmFqOracles = WasmFqOracles;
...
if (Symbol.dispose) WasmFqPlonkVerificationEvals.prototype[Symbol.dispose] = WasmFqPlonkVerificationEvals.prototype.free;
exports.WasmFqPlonkVerificationEvals = WasmFqPlonkVerificationEvals;
...
if (Symbol.dispose) WasmFqPlonkVerifierIndex.prototype[Symbol.dispose] = WasmFqPlonkVerifierIndex.prototype.free;
exports.WasmFqPlonkVerifierIndex = WasmFqPlonkVerifierIndex;
...
if (Symbol.dispose) WasmFqPolyComm.prototype[Symbol.dispose] = WasmFqPolyComm.prototype.free;
exports.WasmFqPolyComm = WasmFqPolyComm;
...
if (Symbol.dispose) WasmFqProverCommitments.prototype[Symbol.dispose] = WasmFqProverCommitments.prototype.free;
exports.WasmFqProverCommitments = WasmFqProverCommitments;
...
if (Symbol.dispose) WasmFqProverProof.prototype[Symbol.dispose] = WasmFqProverProof.prototype.free;
exports.WasmFqProverProof = WasmFqProverProof;
...
if (Symbol.dispose) WasmFqRandomOracles.prototype[Symbol.dispose] = WasmFqRandomOracles.prototype.free;
exports.WasmFqRandomOracles = WasmFqRandomOracles;
...
if (Symbol.dispose) WasmFqRuntimeTable.prototype[Symbol.dispose] = WasmFqRuntimeTable.prototype.free;
exports.WasmFqRuntimeTable = WasmFqRuntimeTable;
...
if (Symbol.dispose) WasmFqShifts.prototype[Symbol.dispose] = WasmFqShifts.prototype.free;
exports.WasmFqShifts = WasmFqShifts;
...
class WasmFqSrs {
    ...
    static deserialize(bytes) {
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmfqsrs_deserialize(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WasmFqSrs.__wrap(ret[0]);
    }
    /**
     * @returns {Uint8Array}
     */
    serialize() {
        const ret = wasm.wasmfqsrs_serialize(this.__wbg_ptr);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
if (Symbol.dispose) WasmFqSrs.prototype[Symbol.dispose] = WasmFqSrs.prototype.free;
exports.WasmFqSrs = WasmFqSrs;
...
if (Symbol.dispose) WasmGPallas.prototype[Symbol.dispose] = WasmGPallas.prototype.free;
exports.WasmGPallas = WasmGPallas;
...
if (Symbol.dispose) WasmGVesta.prototype[Symbol.dispose] = WasmGVesta.prototype.free;
exports.WasmGVesta = WasmGVesta;
...
if (Symbol.dispose) WasmGateWires.prototype[Symbol.dispose] = WasmGateWires.prototype.free;
exports.WasmGateWires = WasmGateWires;
...
if (Symbol.dispose) WasmPallasGProjective.prototype[Symbol.dispose] = WasmPallasGProjective.prototype.free;
exports.WasmPallasGProjective = WasmPallasGProjective;
...
if (Symbol.dispose) WasmPastaFpLookupTable.prototype[Symbol.dispose] = WasmPastaFpLookupTable.prototype.free;
exports.WasmPastaFpLookupTable = WasmPastaFpLookupTable;
...
class WasmPastaFpPlonkIndex {
    ...
    static deserialize(bytes) {
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmpastafpplonkindex_deserialize(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
     ...
     */
    serialize() {
        const ret = wasm.wasmpastafpplonkindex_serialize(this.__wbg_ptr);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
if (Symbol.dispose) WasmPastaFpPlonkIndex.prototype[Symbol.dispose] = WasmPastaFpPlonkIndex.prototype.free;
exports.WasmPastaFpPlonkIndex = WasmPastaFpPlonkIndex;
...
if (Symbol.dispose) WasmPastaFpRuntimeTableCfg.prototype[Symbol.dispose] = WasmPastaFpRuntimeTableCfg.prototype.free;
exports.WasmPastaFpRuntimeTableCfg = WasmPastaFpRuntimeTableCfg;
...
if (Symbol.dispose) WasmPastaFqLookupTable.prototype[Symbol.dispose] = WasmPastaFqLookupTable.prototype.free;
exports.WasmPastaFqLookupTable = WasmPastaFqLookupTable;
...
class WasmPastaFqPlonkIndex {
    ...
    static deserialize(bytes) {
        const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmpastafqplonkindex_deserialize(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
     ...
     */
    serialize() {
        const ret = wasm.wasmpastafqplonkindex_serialize(this.__wbg_ptr);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
if (Symbol.dispose) WasmPastaFqPlonkIndex.prototype[Symbol.dispose] = WasmPastaFqPlonkIndex.prototype.free;
exports.WasmPastaFqPlonkIndex = WasmPastaFqPlonkIndex;
...
if (Symbol.dispose) WasmPastaFqRuntimeTableCfg.prototype[Symbol.dispose] = WasmPastaFqRuntimeTableCfg.prototype.free;
exports.WasmPastaFqRuntimeTableCfg = WasmPastaFqRuntimeTableCfg;
...
if (Symbol.dispose) WasmVecFp.prototype[Symbol.dispose] = WasmVecFp.prototype.free;
exports.WasmVecFp = WasmVecFp;
...
if (Symbol.dispose) WasmVecFq.prototype[Symbol.dispose] = WasmVecFq.prototype.free;
exports.WasmVecFq = WasmVecFq;
...
if (Symbol.dispose) WasmVecVecFp.prototype[Symbol.dispose] = WasmVecVecFp.prototype.free;
exports.WasmVecVecFp = WasmVecVecFp;
...
if (Symbol.dispose) WasmVecVecFpPolyComm.prototype[Symbol.dispose] = WasmVecVecFpPolyComm.prototype.free;
exports.WasmVecVecFpPolyComm = WasmVecVecFpPolyComm;
...
if (Symbol.dispose) WasmVecVecFq.prototype[Symbol.dispose] = WasmVecVecFq.prototype.free;
exports.WasmVecVecFq = WasmVecVecFq;
...
if (Symbol.dispose) WasmVecVecFqPolyComm.prototype[Symbol.dispose] = WasmVecVecFqPolyComm.prototype.free;
exports.WasmVecVecFqPolyComm = WasmVecVecFqPolyComm;
...
if (Symbol.dispose) WasmVestaGProjective.prototype[Symbol.dispose] = WasmVestaGProjective.prototype.free;
exports.WasmVestaGProjective = WasmVestaGProjective;
...
exports.caml_bigint_256_bytes_per_limb = caml_bigint_256_bytes_per_limb;
...
exports.caml_bigint_256_compare = caml_bigint_256_compare;
...
exports.caml_bigint_256_deep_copy = caml_bigint_256_deep_copy;
...
exports.caml_bigint_256_div = caml_bigint_256_div;
...
exports.caml_bigint_256_num_limbs = caml_bigint_256_num_limbs;
...
exports.caml_bigint_256_of_bytes = caml_bigint_256_of_bytes;
...
exports.caml_bigint_256_of_decimal_string = caml_bigint_256_of_decimal_string;
...
exports.caml_bigint_256_of_numeral = caml_bigint_256_of_numeral;
...
exports.caml_bigint_256_test_bit = caml_bigint_256_test_bit;
...
exports.caml_bigint_256_to_bytes = caml_bigint_256_to_bytes;

/**
 * @param {WasmFpSrs} srs
 * @param {number} log2_size
 */
function caml_fp_srs_add_lagrange_basis(srs, log2_size) {
    _assertClass(srs, WasmFpSrs);
    wasm.caml_fp_srs_add_lagrange_basis(srs.__wbg_ptr, log2_size);
}
exports.caml_fp_srs_add_lagrange_basis = caml_fp_srs_add_lagrange_basis;
...
exports.caml_fp_srs_b_poly_commitment = caml_fp_srs_b_poly_commitment;
...
exports.caml_fp_srs_batch_accumulator_check = caml_fp_srs_batch_accumulator_check;
...
exports.caml_fp_srs_batch_accumulator_generate = caml_fp_srs_batch_accumulator_generate;
...
exports.caml_fp_srs_commit_evaluations = caml_fp_srs_commit_evaluations;
...
exports.caml_fp_srs_create = caml_fp_srs_create;

/**
 * @param {number} depth
 * @returns {WasmFpSrs}
 */
function caml_fp_srs_create_parallel(depth) {
    const ret = wasm.caml_fp_srs_create_parallel(depth);
    return WasmFpSrs.__wrap(ret);
}
exports.caml_fp_srs_create_parallel = caml_fp_srs_create_parallel;

/**
 * @param {WasmFpSrs} srs
 * @returns {Uint32Array}
 */
function caml_fp_srs_get(srs) {
    _assertClass(srs, WasmFpSrs);
...
exports.caml_fp_srs_get = caml_fp_srs_get;
 ...
 * @returns {Uint32Array}
 */
function caml_fp_srs_get_lagrange_basis(srs, domain_size) {
    _assertClass(srs, WasmFpSrs);
...
exports.caml_fp_srs_get_lagrange_basis = caml_fp_srs_get_lagrange_basis;
...
exports.caml_fp_srs_h = caml_fp_srs_h;
...
exports.caml_fp_srs_lagrange_commitment = caml_fp_srs_lagrange_commitment;
 ...
 * @returns {number}
 */
function caml_fp_srs_lagrange_commitments_whole_domain_ptr(srs, domain_size) {
    _assertClass(srs, WasmFpSrs);
    const ret = wasm.caml_fp_srs_lagrange_commitments_whole_domain_ptr(srs.__wbg_ptr, domain_size);
    return ret >>> 0;
}
exports.caml_fp_srs_lagrange_commitments_whole_domain_ptr = caml_fp_srs_lagrange_commitments_whole_domain_ptr;
 ...
 * @returns {Uint32Array}
 */
function caml_fp_srs_lagrange_commitments_whole_domain_read_from_ptr(ptr) {
    const ret = wasm.caml_fp_srs_lagrange_commitments_whole_domain_read_from_ptr(ptr);
    var v1 = getArrayU32FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
    return v1;
}
exports.caml_fp_srs_lagrange_commitments_whole_domain_read_from_ptr = caml_fp_srs_lagrange_commitments_whole_domain_read_from_ptr;
 ...
 * @returns {WasmFpPolyComm | undefined}
 */
function caml_fp_srs_maybe_lagrange_commitment(srs, domain_size, i) {
    _assertClass(srs, WasmFpSrs);
    const ret = wasm.caml_fp_srs_maybe_lagrange_commitment(srs.__wbg_ptr, domain_size, i);
    return ret === 0 ? undefined : WasmFpPolyComm.__wrap(ret);
}
exports.caml_fp_srs_maybe_lagrange_commitment = caml_fp_srs_maybe_lagrange_commitment;
 ...
 */
function caml_fp_srs_set_lagrange_basis(srs, domain_size, input_bases) {
    _assertClass(srs, WasmFpSrs);
...
exports.caml_fp_srs_set_lagrange_basis = caml_fp_srs_set_lagrange_basis;
...
exports.caml_fp_srs_write = caml_fp_srs_write;
...
exports.caml_fq_srs_add_lagrange_basis = caml_fq_srs_add_lagrange_basis;
...
exports.caml_fq_srs_b_poly_commitment = caml_fq_srs_b_poly_commitment;
...
exports.caml_fq_srs_batch_accumulator_check = caml_fq_srs_batch_accumulator_check;
...
exports.caml_fq_srs_batch_accumulator_generate = caml_fq_srs_batch_accumulator_generate;
...
exports.caml_fq_srs_commit_evaluations = caml_fq_srs_commit_evaluations;
...
exports.caml_fq_srs_create = caml_fq_srs_create;

/**
 * @param {number} depth
 * @returns {WasmFqSrs}
 */
function caml_fq_srs_create_parallel(depth) {
    const ret = wasm.caml_fq_srs_create_parallel(depth);
    return WasmFqSrs.__wrap(ret);
}
exports.caml_fq_srs_create_parallel = caml_fq_srs_create_parallel;

/**
 * @param {WasmFqSrs} srs
 * @returns {Uint32Array}
 */
function caml_fq_srs_get(srs) {
    _assertClass(srs, WasmFqSrs);
...
exports.caml_fq_srs_get = caml_fq_srs_get;
 ...
 * @returns {Uint32Array}
 */
function caml_fq_srs_get_lagrange_basis(srs, domain_size) {
    _assertClass(srs, WasmFqSrs);
...
exports.caml_fq_srs_get_lagrange_basis = caml_fq_srs_get_lagrange_basis;
...
exports.caml_fq_srs_h = caml_fq_srs_h;
...
exports.caml_fq_srs_lagrange_commitment = caml_fq_srs_lagrange_commitment;
 ...
 * @returns {number}
 */
function caml_fq_srs_lagrange_commitments_whole_domain_ptr(srs, domain_size) {
    _assertClass(srs, WasmFqSrs);
    const ret = wasm.caml_fq_srs_lagrange_commitments_whole_domain_ptr(srs.__wbg_ptr, domain_size);
    return ret >>> 0;
}
exports.caml_fq_srs_lagrange_commitments_whole_domain_ptr = caml_fq_srs_lagrange_commitments_whole_domain_ptr;
 ...
 * @returns {Uint32Array}
 */
function caml_fq_srs_lagrange_commitments_whole_domain_read_from_ptr(ptr) {
    const ret = wasm.caml_fq_srs_lagrange_commitments_whole_domain_read_from_ptr(ptr);
    var v1 = getArrayU32FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
    return v1;
}
exports.caml_fq_srs_lagrange_commitments_whole_domain_read_from_ptr = caml_fq_srs_lagrange_commitments_whole_domain_read_from_ptr;
 ...
 * @returns {WasmFqPolyComm | undefined}
 */
function caml_fq_srs_maybe_lagrange_commitment(srs, domain_size, i) {
    _assertClass(srs, WasmFqSrs);
    const ret = wasm.caml_fq_srs_maybe_lagrange_commitment(srs.__wbg_ptr, domain_size, i);
    return ret === 0 ? undefined : WasmFqPolyComm.__wrap(ret);
}
exports.caml_fq_srs_maybe_lagrange_commitment = caml_fq_srs_maybe_lagrange_commitment;
...
exports.caml_fq_srs_read = caml_fq_srs_read;

/**
 * @param {Uint32Array} h_and_gs
 * @returns {WasmFqSrs}
 */
function caml_fq_srs_set(h_and_gs) {
    const ptr0 = passArray32ToWasm0(h_and_gs, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.caml_fq_srs_set(ptr0, len0);
    return WasmFqSrs.__wrap(ret);
}
exports.caml_fq_srs_set = caml_fq_srs_set;
 ...
 * @param {Uint32Array} input_bases
 */
function caml_fq_srs_set_lagrange_basis(srs, domain_size, input_bases) {
    _assertClass(srs, WasmFqSrs);
    const ptr0 = passArray32ToWasm0(input_bases, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.caml_fq_srs_set_lagrange_basis(srs.__wbg_ptr, domain_size, ptr0, len0);
}
exports.caml_fq_srs_set_lagrange_basis = caml_fq_srs_set_lagrange_basis;
...
exports.caml_fq_srs_write = caml_fq_srs_write;
...
exports.caml_pallas_add = caml_pallas_add;
...
exports.caml_pallas_affine_deep_copy = caml_pallas_affine_deep_copy;

/**
 * @returns {WasmGPallas}
 */
function caml_pallas_affine_one() {
    const ret = wasm.caml_pallas_affine_one();
    return WasmGPallas.__wrap(ret);
}
exports.caml_pallas_affine_one = caml_pallas_affine_one;
...
exports.caml_pallas_double = caml_pallas_double;
...
exports.caml_pallas_endo_base = caml_pallas_endo_base;
...
exports.caml_pallas_endo_scalar = caml_pallas_endo_scalar;
...
exports.caml_pallas_negate = caml_pallas_negate;
...
exports.caml_pallas_of_affine = caml_pallas_of_affine;
...
exports.caml_pallas_of_affine_coordinates = caml_pallas_of_affine_coordinates;
...
exports.caml_pallas_one = caml_pallas_one;
...
exports.caml_pallas_random = caml_pallas_random;
...
exports.caml_pallas_rng = caml_pallas_rng;
...
exports.caml_pallas_scale = caml_pallas_scale;
...
exports.caml_pallas_sub = caml_pallas_sub;
...
exports.caml_pallas_to_affine = caml_pallas_to_affine;
 ...
 * @returns {string}
 */
function caml_pasta_fp_plonk_circuit_serialize(public_input_size, v) {
    let deferred1_0;
    let deferred1_1;
    try {
...
exports.caml_pasta_fp_plonk_circuit_serialize = caml_pasta_fp_plonk_circuit_serialize;
...
exports.caml_pasta_fp_plonk_gate_vector_add = caml_pasta_fp_plonk_gate_vector_add;
...
exports.caml_pasta_fp_plonk_gate_vector_create = caml_pasta_fp_plonk_gate_vector_create;
 ...
 * @returns {Uint8Array}
 */
function caml_pasta_fp_plonk_gate_vector_digest(public_input_size, v) {
    _assertClass(v, WasmFpGateVector);
...
exports.caml_pasta_fp_plonk_gate_vector_digest = caml_pasta_fp_plonk_gate_vector_digest;
...
exports.caml_pasta_fp_plonk_gate_vector_get = caml_pasta_fp_plonk_gate_vector_get;
...
exports.caml_pasta_fp_plonk_gate_vector_len = caml_pasta_fp_plonk_gate_vector_len;
...
exports.caml_pasta_fp_plonk_gate_vector_wrap = caml_pasta_fp_plonk_gate_vector_wrap;
 ...
 * @returns {WasmPastaFpPlonkIndex}
 */
function caml_pasta_fp_plonk_index_create(gates, public_, lookup_tables, runtime_table_cfgs, prev_challenges, srs, lazy_mode) {
...
exports.caml_pasta_fp_plonk_index_create = caml_pasta_fp_plonk_index_create;
 ...
 * @returns {WasmPastaFpPlonkIndex}
 */
function caml_pasta_fp_plonk_index_decode(bytes, srs) {
    const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    _assertClass(srs, WasmFpSrs);
...
exports.caml_pasta_fp_plonk_index_decode = caml_pasta_fp_plonk_index_decode;
...
exports.caml_pasta_fp_plonk_index_domain_d1_size = caml_pasta_fp_plonk_index_domain_d1_size;
...
exports.caml_pasta_fp_plonk_index_domain_d4_size = caml_pasta_fp_plonk_index_domain_d4_size;
...
exports.caml_pasta_fp_plonk_index_domain_d8_size = caml_pasta_fp_plonk_index_domain_d8_size;

/**
 * @param {WasmPastaFpPlonkIndex} index
 * @returns {Uint8Array}
 */
function caml_pasta_fp_plonk_index_encode(index) {
    _assertClass(index, WasmPastaFpPlonkIndex);
...
exports.caml_pasta_fp_plonk_index_encode = caml_pasta_fp_plonk_index_encode;
...
exports.caml_pasta_fp_plonk_index_max_degree = caml_pasta_fp_plonk_index_max_degree;
...
exports.caml_pasta_fp_plonk_index_public_inputs = caml_pasta_fp_plonk_index_public_inputs;
...
exports.caml_pasta_fp_plonk_index_read = caml_pasta_fp_plonk_index_read;
...
exports.caml_pasta_fp_plonk_index_write = caml_pasta_fp_plonk_index_write;
...
exports.caml_pasta_fp_plonk_proof_batch_verify = caml_pasta_fp_plonk_proof_batch_verify;
 ...
 * @returns {WasmFpProverProof}
 */
function caml_pasta_fp_plonk_proof_create(index, witness, wasm_runtime_tables, prev_challenges, prev_sgs) {
    _assertClass(index, WasmPastaFpPlonkIndex);
...
exports.caml_pasta_fp_plonk_proof_create = caml_pasta_fp_plonk_proof_create;
...
exports.caml_pasta_fp_plonk_proof_deep_copy = caml_pasta_fp_plonk_proof_deep_copy;
...
exports.caml_pasta_fp_plonk_proof_dummy = caml_pasta_fp_plonk_proof_dummy;
...
exports.caml_pasta_fp_plonk_proof_verify = caml_pasta_fp_plonk_proof_verify;
...
exports.caml_pasta_fp_plonk_verifier_index_create = caml_pasta_fp_plonk_verifier_index_create;
...
exports.caml_pasta_fp_plonk_verifier_index_deep_copy = caml_pasta_fp_plonk_verifier_index_deep_copy;
 ...
 * @returns {WasmFpPlonkVerifierIndex}
 */
function caml_pasta_fp_plonk_verifier_index_deserialize(srs, index) {
    _assertClass(srs, WasmFpSrs);
...
exports.caml_pasta_fp_plonk_verifier_index_deserialize = caml_pasta_fp_plonk_verifier_index_deserialize;
...
exports.caml_pasta_fp_plonk_verifier_index_dummy = caml_pasta_fp_plonk_verifier_index_dummy;
...
exports.caml_pasta_fp_plonk_verifier_index_read = caml_pasta_fp_plonk_verifier_index_read;

/**
 * @param {WasmFpPlonkVerifierIndex} index
 * @returns {string}
 */
function caml_pasta_fp_plonk_verifier_index_serialize(index) {
    let deferred2_0;
    let deferred2_1;
    try {
        _assertClass(index, WasmFpPlonkVerifierIndex);
...
exports.caml_pasta_fp_plonk_verifier_index_serialize = caml_pasta_fp_plonk_verifier_index_serialize;
...
exports.caml_pasta_fp_plonk_verifier_index_shifts = caml_pasta_fp_plonk_verifier_index_shifts;
...
exports.caml_pasta_fp_plonk_verifier_index_write = caml_pasta_fp_plonk_verifier_index_write;
...
exports.caml_pasta_fp_poseidon_block_cipher = caml_pasta_fp_poseidon_block_cipher;
 ...
 * @returns {string}
 */
function caml_pasta_fq_plonk_circuit_serialize(public_input_size, v) {
    let deferred1_0;
    let deferred1_1;
    try {
...
exports.caml_pasta_fq_plonk_circuit_serialize = caml_pasta_fq_plonk_circuit_serialize;
...
exports.caml_pasta_fq_plonk_gate_vector_add = caml_pasta_fq_plonk_gate_vector_add;
...
exports.caml_pasta_fq_plonk_gate_vector_create = caml_pasta_fq_plonk_gate_vector_create;
 ...
 * @returns {Uint8Array}
 */
function caml_pasta_fq_plonk_gate_vector_digest(public_input_size, v) {
    _assertClass(v, WasmFqGateVector);
...
exports.caml_pasta_fq_plonk_gate_vector_digest = caml_pasta_fq_plonk_gate_vector_digest;
...
exports.caml_pasta_fq_plonk_gate_vector_get = caml_pasta_fq_plonk_gate_vector_get;
...
exports.caml_pasta_fq_plonk_gate_vector_len = caml_pasta_fq_plonk_gate_vector_len;
...
exports.caml_pasta_fq_plonk_gate_vector_wrap = caml_pasta_fq_plonk_gate_vector_wrap;
 ...
 * @returns {WasmPastaFqPlonkIndex}
 */
function caml_pasta_fq_plonk_index_create(gates, public_, lookup_tables, runtime_table_cfgs, prev_challenges, srs, lazy_mode) {
...
exports.caml_pasta_fq_plonk_index_create = caml_pasta_fq_plonk_index_create;
 ...
 * @returns {WasmPastaFqPlonkIndex}
 */
function caml_pasta_fq_plonk_index_decode(bytes, srs) {
    const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    _assertClass(srs, WasmFqSrs);
...
exports.caml_pasta_fq_plonk_index_decode = caml_pasta_fq_plonk_index_decode;
...
exports.caml_pasta_fq_plonk_index_domain_d1_size = caml_pasta_fq_plonk_index_domain_d1_size;
...
exports.caml_pasta_fq_plonk_index_domain_d4_size = caml_pasta_fq_plonk_index_domain_d4_size;
...
exports.caml_pasta_fq_plonk_index_domain_d8_size = caml_pasta_fq_plonk_index_domain_d8_size;

/**
 * @param {WasmPastaFqPlonkIndex} index
 * @returns {Uint8Array}
 */
function caml_pasta_fq_plonk_index_encode(index) {
    _assertClass(index, WasmPastaFqPlonkIndex);
...
exports.caml_pasta_fq_plonk_index_encode = caml_pasta_fq_plonk_index_encode;
...
exports.caml_pasta_fq_plonk_index_max_degree = caml_pasta_fq_plonk_index_max_degree;
...
exports.caml_pasta_fq_plonk_index_public_inputs = caml_pasta_fq_plonk_index_public_inputs;
...
exports.caml_pasta_fq_plonk_index_read = caml_pasta_fq_plonk_index_read;
...
exports.caml_pasta_fq_plonk_index_write = caml_pasta_fq_plonk_index_write;
...
exports.caml_pasta_fq_plonk_proof_batch_verify = caml_pasta_fq_plonk_proof_batch_verify;
 ...
 * @returns {WasmFqProverProof}
 */
function caml_pasta_fq_plonk_proof_create(index, witness, wasm_runtime_tables, prev_challenges, prev_sgs) {
    _assertClass(index, WasmPastaFqPlonkIndex);
...
exports.caml_pasta_fq_plonk_proof_create = caml_pasta_fq_plonk_proof_create;
...
exports.caml_pasta_fq_plonk_proof_deep_copy = caml_pasta_fq_plonk_proof_deep_copy;
...
exports.caml_pasta_fq_plonk_proof_dummy = caml_pasta_fq_plonk_proof_dummy;
...
exports.caml_pasta_fq_plonk_proof_verify = caml_pasta_fq_plonk_proof_verify;
...
exports.caml_pasta_fq_plonk_verifier_index_create = caml_pasta_fq_plonk_verifier_index_create;
...
exports.caml_pasta_fq_plonk_verifier_index_deep_copy = caml_pasta_fq_plonk_verifier_index_deep_copy;
 ...
 * @returns {WasmFqPlonkVerifierIndex}
 */
function caml_pasta_fq_plonk_verifier_index_deserialize(srs, index) {
    _assertClass(srs, WasmFqSrs);
    const ptr0 = passStringToWasm0(index, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.caml_pasta_fq_plonk_verifier_index_deserialize = caml_pasta_fq_plonk_verifier_index_deserialize;
...
exports.caml_pasta_fq_plonk_verifier_index_dummy = caml_pasta_fq_plonk_verifier_index_dummy;
...
exports.caml_pasta_fq_plonk_verifier_index_read = caml_pasta_fq_plonk_verifier_index_read;

/**
 * @param {WasmFqPlonkVerifierIndex} index
 * @returns {string}
 */
function caml_pasta_fq_plonk_verifier_index_serialize(index) {
    let deferred2_0;
    let deferred2_1;
    try {
        _assertClass(index, WasmFqPlonkVerifierIndex);
...
exports.caml_pasta_fq_plonk_verifier_index_serialize = caml_pasta_fq_plonk_verifier_index_serialize;
...
exports.caml_pasta_fq_plonk_verifier_index_shifts = caml_pasta_fq_plonk_verifier_index_shifts;
...
exports.caml_pasta_fq_plonk_verifier_index_write = caml_pasta_fq_plonk_verifier_index_write;

/**
 * @param {Uint8Array} state
 * @returns {Uint8Array}
 */
function caml_pasta_fq_poseidon_block_cipher(state) {
    const ptr0 = passArray8ToWasm0(state, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.caml_pasta_fq_poseidon_block_cipher = caml_pasta_fq_poseidon_block_cipher;
...
exports.caml_vesta_add = caml_vesta_add;
...
exports.caml_vesta_affine_deep_copy = caml_vesta_affine_deep_copy;

/**
 * @returns {WasmGVesta}
 */
function caml_vesta_affine_one() {
    const ret = wasm.caml_vesta_affine_one();
    return WasmGVesta.__wrap(ret);
}
exports.caml_vesta_affine_one = caml_vesta_affine_one;
...
exports.caml_vesta_double = caml_vesta_double;
...
exports.caml_vesta_endo_base = caml_vesta_endo_base;
...
exports.caml_vesta_endo_scalar = caml_vesta_endo_scalar;
...
exports.caml_vesta_negate = caml_vesta_negate;
...
exports.caml_vesta_of_affine = caml_vesta_of_affine;
...
exports.caml_vesta_of_affine_coordinates = caml_vesta_of_affine_coordinates;
...
exports.caml_vesta_one = caml_vesta_one;
...
exports.caml_vesta_random = caml_vesta_random;
...
exports.caml_vesta_rng = caml_vesta_rng;
...
exports.caml_vesta_scale = caml_vesta_scale;
...
exports.caml_vesta_sub = caml_vesta_sub;
...
exports.caml_vesta_to_affine = caml_vesta_to_affine;
...
exports.create_zero_u32_ptr = create_zero_u32_ptr;

/**
 * @returns {Promise<any>}
 */
function exitThreadPool() {
    const ret = wasm.exitThreadPool();
    return ret;
}
exports.exitThreadPool = exitThreadPool;
...
exports.fp_oracles_create = fp_oracles_create;
...
exports.fp_oracles_deep_copy = fp_oracles_deep_copy;
...
exports.fp_oracles_dummy = fp_oracles_dummy;
...
exports.fq_oracles_create = fq_oracles_create;
...
exports.fq_oracles_deep_copy = fq_oracles_deep_copy;
...
exports.fq_oracles_dummy = fq_oracles_dummy;
...
exports.free_u32_ptr = free_u32_ptr;
 ...
 * @returns {number}
 */
function get_memory_byte_length() {
    const ret = wasm.get_memory_byte_length();
    return ret >>> 0;
}
exports.get_memory_byte_length = get_memory_byte_length;
 ...
 * @returns {Promise<any>}
 */
function initThreadPool(num_threads, worker_source) {
...
exports.prover_to_json = prover_to_json;
...
exports.set_u32_ptr = set_u32_ptr;
...
exports.wait_until_non_zero = wait_until_non_zero;
...
exports.__wbg_instanceof_Memory_a361de6f661b44e2 = function(arg0) {
    let result;
    try {
...
exports.__wbg_log_3034066c1301953a = function(arg0, arg1) {
...
exports.__wbg_startWorkers_a7e36b7cd1734250 = function(arg0, arg1, arg2) {
...
exports.__wbg_terminateWorkers_4c005163907884e4 = function() {
...
exports.memory = new WebAssembly.Memory({initial:19,maximum:65536,shared:true});

const wasmPath = `${__dirname}/kimchi_wasm_bg.wasm`;
