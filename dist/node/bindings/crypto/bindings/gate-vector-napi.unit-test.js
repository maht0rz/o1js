...
const gateVectorCreate = native.caml_pasta_fp_plonk_gate_vector_create ?? native.camlPastaFpPlonkGateVectorCreate;
const gateVectorLen = native.caml_pasta_fp_plonk_gate_vector_len ?? native.camlPastaFpPlonkGateVectorLen;
const gateVectorAdd = native.caml_pasta_fp_plonk_gate_vector_add ?? native.camlPastaFpPlonkGateVectorAdd;
const gateVectorGet = native.caml_pasta_fp_plonk_gate_vector_get ?? native.camlPastaFpPlonkGateVectorGet;
const gateVectorWrap = native.caml_pasta_fp_plonk_gate_vector_wrap ?? native.camlPastaFpPlonkGateVectorWrap;
const gateVectorDigest = native.caml_pasta_fp_plonk_gate_vector_digest ?? native.camlPastaFpPlonkGateVectorDigest;
const circuitSerialize = native.caml_pasta_fp_plonk_circuit_serialize ?? native.camlPastaFpPlonkCircuitSerialize;
const { fp } = napiConversionCore(native);
const zeroField = [0, 0n];
const mlWire = (row, col) => [0, row, col];
const sampleGate = [
    0,
    1,
    [
...
//# sourceMappingURL=gate-vector-napi.unit-test.js.map