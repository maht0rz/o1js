...
try {
    ...
    const moduleUrl = import.meta.url !== undefined ? import.meta.url : pathToFileURL(__filename).href;
    ...
    throw new Error(`Native backend requested but '${slug}' is not installed.\n` +
