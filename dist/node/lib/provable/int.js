...
class UInt128 extends CircuitValue {
     ...
     */
    constructor(x) {
        if (x instanceof UInt128 || x instanceof UInt64 || x instanceof UInt32)
            x = x.value.value;
        let value = Field(x);
        super(value);
    ...
    lessThanOrEqual(y) {
        ...
        return lessThanOrEqualGeneric(this.value, y.value, 1n << 128n, (v) => RangeCheck.rangeCheckN(UInt128.NUM_BITS, v));
    }
    /**
    ...
    assertLessThanOrEqual(y, message) {
        ...
        assertLessThanOrEqualGeneric(this.value, y.value, (v) => RangeCheck.rangeCheckN(UInt128.NUM_BITS, v, message));
    }
    /**
    ...
    lessThan(y) {
        ...
        return lessThanGeneric(this.value, y.value, 1n << 128n, (v) => RangeCheck.rangeCheckN(UInt128.NUM_BITS, v));
    }
    /**
    ...
    assertLessThan(y, message) {
        ...
        assertLessThanGeneric(this.value, y.value, (v) => RangeCheck.rangeCheckN(UInt128.NUM_BITS, v, message));
    }
    /**
...
], UInt128.prototype, "value", void 0);
/**
