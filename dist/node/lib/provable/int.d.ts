...
declare class UInt128 extends CircuitValue {
    ...
    static check(x: UInt128): void;
    static toInput(x: UInt128): HashInput;
    /**
     * Encodes this structure into a JSON-like object.
     */
    static toJSON(x: UInt128): string;
    /**
     ...
     */
    mod(y: UInt128 | number): UInt128;
    /**
     * Multiplication with overflow checking.
     */
    mul(y: UInt128 | number): UInt128;
    /**
     * Addition with overflow checking.
     */
    add(y: UInt128 | number): UInt128;
    /**
     * Subtraction with underflow checking.
     */
    sub(y: UInt128 | number): UInt128;
    /**
     * Bitwise XOR gadget on {@link Field} elements.
     */
    xor(x: UInt128): UInt128;
    /**
     ...
     */
    toBytes(): [UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8];
    /**
     * Split a UInt128 into 16 UInt8s, in big-endian order.
     */
    toBytesBE(): [UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8];
    /**
     ...
     */
    static fromBits(bits: (Bool | boolean)[]): UInt128;
}
/**
