...
import type { WasmFpDomain as NapiFpDomain, WasmFpLookupCommitments as NapiFpLookupCommitments, WasmFpLookupSelectors as NapiFpLookupSelectors, WasmFpLookupVerifierIndex as NapiFpLookupVerifierIndex, WasmFpOpeningProof as NapiFpOpeningProof, WasmFpOracles as NapiFpOracles, WasmFpPlonkVerificationEvals as NapiFpPlonkVerificationEvals, WasmFpPlonkVerifierIndex as NapiFpPlonkVerifierIndex, WasmFpPolyComm as NapiFpPolyComm, WasmFpProverCommitments as NapiFpProverCommitments, WasmFpProverProof as NapiFpProverProof, WasmFpRandomOracles as NapiFpRandomOracles, WasmFpShifts as NapiFpShifts, WasmFpSrs as NapiFpSrs, WasmFqDomain as NapiFqDomain, WasmFqLookupCommitments as NapiFqLookupCommitments, WasmFqLookupSelectors as NapiFqLookupSelectors, WasmFqLookupVerifierIndex as NapiFqLookupVerifierIndex, WasmFqOpeningProof as NapiFqOpeningProof, WasmFqOracles as NapiFqOracles, WasmFqPlonkVerificationEvals as NapiFqPlonkVerificationEvals, WasmFqPlonkVerifierIndex as NapiFqPlonkVerifierIndex, WasmFqPolyComm as NapiFqPolyComm, WasmFqProverCommitments as NapiFqProverCommitments, WasmFqProverProof as NapiFqProverProof, WasmFqRandomOracles as NapiFqRandomOracles, WasmFqShifts as NapiFqShifts, WasmFqSrs as NapiFqSrs, WasmPastaFpLookupTable as NapiPastaFpLookupTable, WasmPastaFqLookupTable as NapiPastaFqLookupTable, WasmVecVecFp as NapiVecVecFp, WasmVecVecFq as NapiVecVecFq } from '../../compiled/node_bindings/kimchi_wasm.cjs';
...
export type PolyCommCtor = new (unshifted: ArrayLike<NapiAffine>, shifted?: NapiAffine | undefined) => NapiPolyComm;
...
export type NapiRuntimeTableCfg = {
    id: number;
...
export type NapiLookupSelector = NapiLookupSelectorShape | NapiFpLookupSelectors | NapiFqLookupSelectors;
