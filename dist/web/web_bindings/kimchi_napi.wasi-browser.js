...
// TEMP CI diagnosis (remove): stage beacons inside the instantiation window
try { void fetch('/__o1js_boot_stage/wasm-fetched') } catch {}
...
const {
  ...
  wasi: __wasi,
  onCreateWorker() {
    try { void fetch('/__o1js_boot_stage/nested-worker-created') } catch {}
